...
public class ColorTabSixPassword extends AppCompatActivity implements View.OnClickListener{
    ...
    private static String TAG = "ColorTabSixPassword";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.color_tab_six_password);
...
//                }
            ...
            case R.id.complete:
                ...
                Intent intent = new Intent(getApplicationContext(), RE_ColorTabSixPassword.class);
    ...
    public void tabColorSetting(){
        ...
        Log.d(TAG, "ㅁㅁㅁ"+colorname[0]);
        Log.d(TAG, "ㅁㅁㅁ"+colorname[1]);
        Log.d(TAG, "ㅁㅁㅁ"+colorname[2]);
        Log.d(TAG, "ㅁㅁㅁ"+colorname[3]);
        Log.d(TAG, "ㅁㅁㅁ"+colorname[4]);
        Log.d(TAG, "ㅁㅁㅁ"+colorname[5]);
...
//        button4.setBackgroundColor(Integer.parseInt(color4));
    ...
    public int getButtonColor(int button_num){
        ...
        SharedPreferences prefs = getSharedPreferences("color", MODE_PRIVATE);
        Log.d(TAG, "버튼 번호 >> "+String.valueOf(button_num));
        if(button_num == 1){
            String colorname = prefs.getString("color1", "#FFFFFF");
            Log.d(TAG, "색 이름 >> "+colorname);
