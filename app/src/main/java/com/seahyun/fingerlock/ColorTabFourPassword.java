...
public class ColorTabFourPassword extends AppCompatActivity implements View.OnClickListener{
    ...
    private static String TAG = "ColorTabFourPassword";
...
//                }
            ...
            case R.id.complete:
                ...
                Intent intent = new Intent(getApplicationContext(), RE_ColorTabFourPassword.class);
