...
public class RE_TouchTabFivePassword extends AppCompatActivity implements View.OnClickListener{
    ...
    private static String TAG = "TouchTabFivePassword";
    TouchTabFivePassword o = new TouchTabFivePassword();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.touch_tab_five_password);
        ...
        switch (v.getId()) {
            ...
            case R.id.complete:
                if(check_password() == true){
                    ...
                    password_count=0;
                    Intent intent = new Intent(getApplicationContext(), TouchTabFivePassword.class);
                    startActivity(intent);
                    finish();
                }
                break;
