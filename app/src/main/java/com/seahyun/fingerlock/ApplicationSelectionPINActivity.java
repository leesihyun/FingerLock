...
public class ApplicationSelectionPINActivity extends Activity {
                   ...
                   //
                    ...
                    //if (num == 4) {//터치탭 개수가 4개일 때
                        if(prefs2.getBoolean("select1",false)==true) { //선택한 어플을 터치탭에 등록
                            ...
                            prefsEditor2.putString("msgP1", shortcut[0]);
                            prefsEditor2.commit();

                            prefsEditor3.putString("nameP1", info.activityInfo.packageName);
                            prefsEditor3.commit();

                            Log.d("1번 바로가기 설정된 앱 >> ", shortcut[0]);
                            Log.d("패키지 이름 >> ", prefs4.getString("nameP1", ""));
                        }
                            ...
                            prefsEditor2.putString("msgP2", shortcut[1]);
                            prefsEditor2.commit();
                            prefsEditor3.putString("nameP2", info.activityInfo.packageName);
                            prefsEditor3.commit();
                           ...
                           // prefsEditor5.commit();
                            ...
                            prefsEditor2.putString("msgP3", shortcut[2]);
                            prefsEditor2.commit();

                            prefsEditor3.putString("nameP3", info.activityInfo.packageName);
                            prefsEditor3.commit();
...
//                            shortcut[i] = msg;
                            ...
                            prefsEditor2.putString("msgP4", shortcut[3]);
                            prefsEditor2.commit();

                            prefsEditor3.putString("nameP4", info.activityInfo.packageName);
                            prefsEditor3.commit();
...
//                            shortcut[i] = msg;
                            ...
                            prefsEditor2.putString("msgP5", shortcut[4]);
                            prefsEditor2.commit();

                            prefsEditor3.putString("nameP5", info.activityInfo.packageName);
                            prefsEditor3.commit();
...
//                            int i = prefs.getInt("passwd", 0);
                            ...
                            prefsEditor2.putString("msgP6", shortcut[5]);
                            prefsEditor2.commit();

                            prefsEditor3.putString("nameP6", info.activityInfo.packageName);
                            prefsEditor3.commit();
