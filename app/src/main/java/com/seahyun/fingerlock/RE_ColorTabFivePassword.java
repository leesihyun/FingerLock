...
public class RE_ColorTabFivePassword extends AppCompatActivity implements View.OnClickListener{
    ...
    private static String TAG = "RE_ColorTabFivePassword";
    ...
    ColorTabFivePassword o = new ColorTabFivePassword();
...
//                }
            ...
            case R.id.complete:
                if(check_password() == true){
                    ...
                    o.input_arr.clear();
                    //password_count=0;
                    Intent intent = new Intent(getApplicationContext(), ColorTabFivePassword.class);
                    startActivity(intent);
                    finish();
                }
                break;
