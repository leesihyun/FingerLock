...
public class RE_ColorTabSixPassword extends AppCompatActivity implements View.OnClickListener{
    ...
    private static String TAG = "RE_ColorTabSixPassword";
    ...
    ColorTabSixPassword o = new ColorTabSixPassword();
...
//                }
            ...
            case R.id.complete:
                if(check_password() == true){
                    ...
                    o.input_arr.clear();
                    //password_count=0;
                    Intent intent = new Intent(getApplicationContext(), ColorTabSixPassword.class);
                    startActivity(intent);
                    finish();
                }
                break;
...
//        button4.setBackgroundColor(Integer.parseInt(color4));
    ...
    public int setPasswd(int colorid){
        ...
        if(colorid == color[0])
            ...
            num = 4;
        else if(colorid == color[4])
            num = 5;
        else if(colorid == color[5])
            num = 6;
